...
const moonTarotCards = {
    ...
    newMoon: {
        ...
        name: '新月',
        emoji: '🌑',
        image: getImagePath('/assets/images/tarot-cards/new-moon.png'),
        meaning: '新しい始まり',
    ...
    crescentMoon: {
        ...
        name: '三日月',
        emoji: '🌒',
        image: getImagePath('/assets/images/tarot-cards/crescent-moon.jpg'),
        meaning: '希望の芽生え',
    ...
    firstQuarter: {
        ...
        name: '上弦の月',
        emoji: '🌓',
        image: getImagePath('/assets/images/tarot-cards/first-quarter.jpg'),
        meaning: '決断の時',
    ...
    waxingGibbous: {
        ...
        name: '十三夜月',
        emoji: '🌔',
        image: getImagePath('/assets/images/tarot-cards/waxing-gibbous.jpg'),
        meaning: 'バランスと調和',
    ...
    fullMoon: {
        ...
        name: '満月',
        emoji: '🌕',
        image: getImagePath('/assets/images/tarot-cards/full-moon.jpg'),
        meaning: '成就と最高潮',
    ...
    waningGibbous: {
        ...
        name: '十六夜月',
        emoji: '🌖',
        image: getImagePath('/assets/images/tarot-cards/waning-gibbous.jpg'),
        meaning: '余韻と感謝',
    ...
    lastQuarter: {
        ...
        name: '下弦の月',
        emoji: '🌗',
        image: getImagePath('/assets/images/tarot-cards/last-quarter.jpg'),
        meaning: '手放しと整理',
    ...
    waningCrescent: {
        ...
        name: '暁月',
        emoji: '🌘',
        image: getImagePath('/assets/images/tarot-cards/waning-crescent.jpg'),
        meaning: '終わりと再生',
    ...
    moonlight: {
        ...
        name: '月光',
        emoji: '✨',
        image: getImagePath('/assets/images/tarot-cards/moonlight.jpg'),
        meaning: '真実の照明',
    ...
    moonShadow: {
        ...
        name: '月影',
        emoji: '🌚',
        image: getImagePath('/assets/images/tarot-cards/moon-shadow.jpg'),
        meaning: '隠された感情',
    ...
    moonTears: {
        ...
        name: '月の涙',
        emoji: '💧',
        image: getImagePath('/assets/images/tarot-cards/moon-tears.jpg'),
        meaning: '浄化と癒し',
    ...
    moonSmile: {
        ...
        name: '月の微笑み',
        emoji: '🌙',
        image: getImagePath('/assets/images/tarot-cards/moon-smile.jpg'),
        meaning: '幸運の前兆',
    ...
    eclipse: {
        ...
        name: '月食',
        emoji: '🌑',
        image: getImagePath('/assets/images/tarot-cards/eclipse.jpg'),
        meaning: '大きな変化',
    ...
    superMoon: {
        ...
        name: 'スーパームーン',
        emoji: '🌕',
        image: getImagePath('/assets/images/tarot-cards/super-moon.jpg'),
        meaning: '特別な機会',
    ...
    blueMoon: {
        ...
        name: 'ブルームーン',
        emoji: '🔵',
        image: getImagePath('/assets/images/tarot-cards/blue-moon.jpg'),
        meaning: '奇跡的な出会い',
    ...
    moonMirror: {
        ...
        name: '月の鏡',
        emoji: '🪞',
        image: getImagePath('/assets/images/tarot-cards/moon-mirror.jpg'),
        meaning: '自己との対話',
    ...
    bloodMoon: {
        ...
        name: 'ブラッドムーン',
        emoji: '🔴',
        image: getImagePath('/assets/images/tarot-cards/blood-moon.jpg'),
        meaning: '情熱の爆発',
