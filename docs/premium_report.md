...
**物語の意図**: 時間帯分析、感情分析、総合スコアを通じて、「実は思っているより良い関係」であることを示す。データに基づいた安心感を提供し、関係性に対する自信を育む。

### 転：核心的な答え（P.7～P.9）
**目的**: 「あなたが本当に知りたいことへの明確な答え」

**物語の意図**: ここが物語のクライマックス。P9で相談者の`wantToKnow`に応じた専用ページを設け、最も知りたかったことへの明確な答えを提供する。
- `feelings`: 相手の本当の気持ちを会話パターンから読み解く
- `action`: 今すぐ取るべき具体的な行動指針
- `past`: 過去の出来事が持つ心理的意味の解釈
- `future`: データに基づく関係性の未来予測

### 結：希望への道筋（P.10～P.13）
**目的**: 「これからどうすればいいか」の明確化

**物語の意図**: 段階的なアクションプラン（今すぐ/1週間/1ヶ月）、3ヶ月後の明るい未来像、月詠からの最後の祝福で締めくくる。読み終えた時に「よし、やってみよう」という前向きな気持ちになれる構成。
