  ...
  constructor() {
    ...
    this.moonPhaseTypes = {
      ...
      waxingCrescent: {
        ...
        symbol: '🌒',
        traits: '成長と希望の追求者',
        description: '希望に満ちた楽観主義者。少しずつ関係を深めていくことを好み、相手の成長を見守ることに喜びを感じます。',
      ...
      firstQuarter: {
        ...
        symbol: '🌓',
        traits: '決断力のあるリーダー',
        description: '強い意志と決断力を持つリーダータイプ。恋愛では主導権を握ることが多く、相手を引っ張っていく力があります。',
      ...
      waxingGibbous: {
        ...
        symbol: '🌔',
        traits: '完璧を求める努力家',
        description: '理想が高く、完璧を求める努力家。恋愛においても真剣で、相手との関係を大切に育てていきます。',
      ...
      fullMoon: {
        ...
        symbol: '🌕',
        traits: 'カリスマ性のある表現者',
        description: '明るく華やかで、人を惹きつける魅力があります。感情表現が豊かで、愛情を惜しみなく相手に注ぎます。',
      ...
      waningGibbous: {
        ...
        symbol: '🌖',
        traits: '知恵と経験の伝道者',
        description: '経験豊富で落ち着いた大人の魅力を持つタイプ。相手を包み込むような優しさで、安心感を与えます。',
      ...
      lastQuarter: {
        ...
        symbol: '🌗',
        traits: '内省的な思索家',
        description: '深い思考力と洞察力を持つ哲学者タイプ。恋愛では慎重で、相手の本質を見極めようとします。',
      ...
      waningCrescent: {
        ...
        symbol: '🌘',
        traits: '直感力の高い神秘家',
        description: 'ミステリアスな魅力を持ち、直感力が非常に高いタイプ。深い精神的な繋がりを求める恋愛をします。',
