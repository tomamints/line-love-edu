...
class MoonFortuneEngineV2 {
  ...
  getSpecificCompatibilityAdvice(userType, partnerType) {
    ...
    const adviceMap = {
      ...
      '新月-三日月': {
        reason: '三日月の配慮と新月の行動力がバランスよく調和',
        example: '新月が提案し、三日月が細かい調整をして実現する',
        advice: 'お互いの長所を活かして、無理なく新しいことに挑戦できます'
      },
      '新月-上弦の月': {
        reason: '上弦の計画性が新月の衝動を現実的に導く',
        example: '新月のアイデアを上弦が計画に落とし込んで実現',
        advice: '勢いと戦略のバランスが取れた良い関係'
      },
      '新月-十三夜': {
        reason: '十三夜の穏やかさが、新月の勢いを優しく長持ちさせる',
        example: '新月の急な旅行提案に、十三夜が交通や宿を整えてくれて快適に実現',
        advice: '新月は安心感を得ながら、ペースを緩めずに進めます'
      },
      '新月-満月': {
      ...
      '新月-十六夜': {
        reason: '十六夜の落ち着きが新月の熱を程よくクールダウン',
        example: '新月が興奮しすぎた時、十六夜が優しく落ち着かせる',
        advice: 'バランスを保ちながら、お互いを成長させる関係'
      },
      '新月-下弦の月': {
        reason: '下弦の整理力が新月の散らかりがちなエネルギーをまとめる',
        example: '新月が始めたことを下弦が整理して継続可能にする',
        advice: '衝動と整理のバランスが必要ですが、協力すれば良い結果に'
      },
      '新月-暁': {
        reason: '暁の深い内省が新月に新しい視点を与える',
      ...
      '三日月-新月': {
        ...
        example: '新月の提案を三日月が現実的に調整して実現',
        advice: 'お互いのペースを尊重しながら前進できます'
      },
      '三日月-三日月': {
        reason: '似たペースと価値観で安心感抜群',
        example: 'どちらからも急かさず、自然に「また会おうね」と次の約束が決まる',
        advice: '互いの領域を尊重しつつ、じっくり愛を育てられます'
      },
      '三日月-上弦の月': {
      ...
      '三日月-十三夜': {
        reason: '穏やかな二人が作る安定した関係',
        example: 'お互いのペースを大切にしながら、ゆっくり関係を深める',
        advice: '長続きする穏やかで優しい関係を築けます'
      },
      '三日月-満月': {
        reason: '満月の明るさが三日月の内向性を優しく照らす',
        example: '満月が三日月を励まし、新しい世界へ導く',
        advice: '三日月は満月から勇気をもらい、より積極的になれます'
      },
      '三日月-十六夜': {
        reason: '十六夜の包容力が三日月の遠慮をほどく',
        example: '十六夜が「今日は君の行きたい所に行こう」と提案し、三日月が素直に希望を言える',
        advice: '深く落ち着いた関係を長く維持できます'
      },
      '三日月-下弦の月': {
        reason: '下弦の整理力と三日月の柔軟性が良いバランス',
        example: '三日月の柔軟さを下弦が受け止め、穏やかな流れを作る',
        advice: 'お互いの長所を活かした安定した関係'
      },
      '三日月-暁': {
        reason: '二人とも内向的でペースが似ている',
      ...
      '上弦の月-新月': {
        ...
        example: '新月のアイデアを上弦が段取りして実現',
        advice: '理想的な実行パートナーシップ'
      },
      '上弦の月-三日月': {
        reason: '三日月の慎重さを、上弦の設計力がやさしく前進させる',
        example: '三日月が「混んでるの苦手」と言えば、上弦が混雑回避ルート＋予約を段取り',
        advice: '三日月は安心して一歩を踏み出せ、上弦は「進める役割」を心地よく担えます'
      },
      '上弦の月-上弦の月': {
        reason: '計画力×計画力で完璧な実行',
        example: '二人で緻密な計画を立て、着実に実行',
        advice: '時には直感的な行動も大切にしましょう'
      },
      '上弦の月-十三夜': {
        reason: '十三夜の安定感と上弦の推進力が良いバランス',
        example: '上弦が提案し、十三夜が現実的に調整',
        advice: '無理なく着実に前進できる関係'
      },
      '上弦の月-満月': {
        reason: '満月の情熱を上弦が形にする',
        example: '満月の夢を上弦が計画して実現',
        advice: '感情と論理のバランスが取れた関係'
      },
      '上弦の月-十六夜': {
        reason: '十六夜の余裕が上弦の焦りを和らげる',
        example: '上弦が急ぎすぎた時、十六夜が優しくペースダウン',
        advice: '急がず焦らず、着実に進む関係'
      },
      '上弦の月-下弦の月': {
        reason: '行動（上弦）×整理（下弦）の補完関係',
        example: '引っ越しを検討するとき、上弦が候補を集め、下弦が条件表で比較',
        advice: '上弦が広げた選択肢を、下弦がムダなく絞り込む。決断の質が上がります'
      },
      '上弦の月-暁': {
        reason: '上弦の行動力が暁を引っ張ってくれる',
      ...
      '十三夜-新月': {
        ...
        example: '新月が「来週、急だけど温泉行かない？」——十三夜は予算と交通だけ整えてGO',
        advice: 'あなたの安定感が新月の勢いを安心して継続させます'
      },
      '十三夜-三日月': {
        reason: '穏やかな二人が作る安らぎの空間',
        example: 'お互いのペースを大切にしながら関係を育む',
        advice: '無理なく自然体でいられる関係'
      },
      '十三夜-上弦の月': {
        reason: '上弦の計画性と十三夜の安定感が調和',
        example: '上弦が提案し、十三夜が現実的に支える',
        advice: 'バランスの取れた建設的な関係'
      },
      '十三夜-十三夜': {
        reason: '似たテンポと価値観。衝突が少なく、静かな幸福が長く続く',
        example: '記念日は外食1回＋自宅でデザート。派手さより満ち足りた余白を共有',
        advice: '穏やかで安定した長期的な関係'
      },
      '十三夜-満月': {
        reason: '満月の明るさと十三夜の落ち着きが良いバランス',
        example: '満月が盛り上げ、十三夜が支える',
        advice: '感情と理性のバランスが取れた関係'
      },
      '十三夜-十六夜': {
        reason: '二人とも成熟した落ち着きがある',
        example: '大人の余裕を持った関係',
        advice: '時には刺激も必要かもしれません'
      },
      '十三夜-下弦の月': {
        reason: '下弦の"手放し・整理"が、十三夜の"保持・安定"と時に衝突',
        example: '物を減らしたい下弦、思い出を残したい十三夜。"思い出はデータ化、実物は厳選"の中庸で◎',
        advice: '役割が噛み合えば堅実な関係'
      },
      '十三夜-暁': {
      ...
      '満月-新月': {
        ...
        example: '新月の「突然だけど旅行行こう！」に、満月が即ノリで熱量倍増',
        advice: '情熱的で刺激的な関係'
      },
      '満月-三日月': {
        reason: '満月の明るさが三日月を優しく照らす',
        example: '満月が三日月を励まし、新しい世界へ導く',
        advice: '満月が三日月に勇気を与える関係'
      },
      '満月-上弦の月': {
        reason: '満月の情熱を上弦が形にする',
        example: '満月の夢を上弦が計画して実現',
        advice: '感情と実行力の良いコンビネーション'
      },
      '満月-十三夜': {
        reason: '満月の熱と十三夜の安定感がバランス',
        example: '満月が盛り上げ、十三夜が支える',
        advice: '情熱と安定の調和'
      },
      '満月-満月': {
        reason: '感情表現豊かな二人の情熱的な関係',
        example: '喜びも悲しみも全力で共有',
        advice: '時にはクールダウンも必要'
      },
      '満月-十六夜': {
        reason: '十六夜の落ち着きが満月の熱をやわらげ、安定感と情熱の両立が可能',
        example: '興奮して話しすぎた後、十六夜が「少し散歩しよう」とクールダウンを促してくれる',
        advice: 'バランスの取れた情熱的な関係'
      },
      '満月-下弦の月': {
        reason: '下弦の冷静さが満月の熱を整理',
        example: '満月の感情を下弦が整理して方向性を示す',
        advice: '感情と理性のバランスが鍵'
      },
      '満月-暁': {
        reason: '満月の外向性と暁の内向性の対比',
      ...
      '十六夜-新月': {
        ...
        example: '新月の衝動を十六夜が優しく導く',
        advice: '新月は安心して冒険できます'
      },
      '十六夜-三日月': {
        reason: '慎重で配慮ある三日月と、成熟した余裕で安定感抜群',
        example: '十六夜が三日月の遠慮を優しくほどく',
        advice: '深く落ち着いた関係'
      },
      '十六夜-上弦の月': {
        reason: '上弦の焦りを十六夜が和らげる',
        example: '急ぎすぎる上弦に十六夜がペースダウンを促す',
        advice: '焦らず着実に進む関係'
      },
      '十六夜-十三夜': {
        reason: '二人とも成熟した大人の関係',
        example: '落ち着いた大人のデート',
        advice: '安定しすぎて刺激不足に注意'
      },
      '十六夜-満月': {
        reason: '満月の情熱をやさしく受け止め、熱をちょうどよく保つ',
        example: '満月の感情を十六夜が包み込む',
        advice: '情熱と落ち着きの調和'
      },
      '十六夜-十六夜': {
        reason: '似た者同士で、安らぎと落ち着きを共有できる',
        example: '静かで穏やかな時間を共有',
        advice: '時には新しい刺激も必要'
      },
      '十六夜-下弦の月': {
        reason: '二人とも引き算の美学を理解',
        example: 'シンプルで質の高い生活を共有',
        advice: '落ち着いた大人の関係'
      },
      '十六夜-暁': {
        reason: '深い内省と成熟した余裕の調和',
        example: '静かに深い対話を楽しむ',
        advice: '精神的に豊かな関係'
      },
      ...
      '下弦の月-新月': {
        ...
        example: '新月が始めたことを下弦がまとめる',
        advice: '役割分担を明確にすると良い'
      },
      '下弦の月-三日月': {
        reason: '三日月の柔軟さを下弦が受け止め、穏やかな流れを作る',
        example: '三日月の優しさと下弦の整理力が調和',
        advice: '穏やかで整理された関係'
      },
      '下弦の月-上弦の月': {
        reason: '上弦の提案力＋下弦の整理力で最適解に辿り着ける',
        example: '上弦が選択肢を広げ、下弦が絞り込む',
        advice: '完璧なパートナーシップ'
      },
      '下弦の月-十三夜': {
        reason: '保持と整理のバランスが必要',
        example: '思い出の扱い方で意見が分かれることも',
        advice: '中庸を見つけることが大切'
      },
      '下弦の月-満月': {
        reason: '満月の感情を下弦が整理',
        example: '感情的になった満月を下弦が冷静に導く',
        advice: '感情と理性のバランス'
      },
      '下弦の月-十六夜': {
        reason: '二人とも引き算の美学を理解',
        example: 'シンプルで質の高い暮らし',
        advice: '落ち着いた関係'
      },
      '下弦の月-下弦の月': {
        reason: '同じペースと価値観で、争いがほぼない',
        example: '整理整頓された生活を共有',
        advice: '時には散らかすことも必要'
      },
      '下弦の月-暁': {
        reason: '暁の内省と下弦の安定が深く噛み合い、静かに育つ関係',
      ...
      '暁-新月': {
        ...
        example: '新月が暁を外へ連れ出す',
        advice: 'ペースの違いを理解し合うことが大切'
      },
      '暁-三日月': {
        reason: '二人とも内向的で静かな関係',
        example: '静かな場所でゆっくり過ごす',
        advice: '時には外の世界へも目を向けて'
      },
      '暁-上弦の月': {
        reason: '上弦の行動力が暁を引っ張ってくれる',
        example: '暁が迷っている時、上弦が道を示す',
        advice: '上弦のペースについていくのは大変かも'
      },
      '暁-十三夜': {
        reason: '穏やかさと価値観が合い、長く安定した関係に',
        example: '静かで深い対話を楽しむ',
        advice: '心が通い合う深い関係'
      },
      '暁-満月': {
        reason: '満月の明るさと暁の静けさの対比',
        example: '満月が暁を明るく照らす',
        advice: 'お互いの世界を尊重することが大切'
      },
      '暁-十六夜': {
        reason: '成熟した余裕と深い内省の調和',
        example: '大人の深い対話',
        advice: '精神的に豊かな関係'
      },
      '暁-下弦の月': {
        reason: '下弦の整理力と暁の内省が噛み合い、静かで深い関係に',
        example: '整理された静かな生活',
        advice: '深い理解と共感'
      },
      '暁-暁': {
        reason: '同じペースで、無理なく付き合える',
        example: '静寂の中で心が通い合う',
        advice: '時には外の刺激も必要'
      }
    };
