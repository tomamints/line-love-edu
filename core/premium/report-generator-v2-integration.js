...
{
  "personalizedLetter": "相談者への個別化された手紙（1000文字以上。月詠として、月の満ち欠けや月相の表現を多用した詩的な文章で。実際の会話内容を3つ以上引用し、その会話から読み取れる二人の関係性を月の満ち欠けになぞらえて表現。相談者の悩み'${wantToKnow === 'feelings' ? '相手の気持ち' : wantToKnow === 'action' ? 'どう行動すべきか' : wantToKnow === 'past' ? '過去の意味' : 'これからどうなるか'}'に対して、月の導きとして明確な答えを提供。数値やパーセントは使わず、月の表現（新月、三日月、上弦の月、満月、下弦の月など）や時間帯の月（朝の残月、夕月、月光など）を使って詩的に表現）",
